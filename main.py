...
from web_scraping import do_google_search
...
def main(): 
    ...
    # Create train data
    np_hp_arry_train = stock_processor.convert_to_readable_data('dataset_info/AMD/AMD_train.json')
    ...
    # Create test data
    np_hp_arry_test = stock_processor.convert_to_readable_data('dataset_info/AMD/AMD_val.json')
    ...
    plot_stock_data([actual_predictions], 'experiment_results', ['predictions'])
